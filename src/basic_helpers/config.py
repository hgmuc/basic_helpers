...
CtryCodes: TypeAlias = Literal[
    'AD', 'AL', 'AM', 'AT', 'BA', 'BE', 'BG', 'BY', 'CH', 'CV', 'CY', 'CZ', 'DE', 'DK', 
    'EE', 'ES', 'FI', 'FO', 'FR', 'GB', 'GE', 'GG', 'GR', 'HR', 'HU', 'IE', 'IS', 'IT', 
    'LI', 'LT', 'LU', 'LV', 'MC', 'MD', 'ME', 'MK', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 
    'RS', 'RU', 'SE', 'SI', 'SK', 'SM', 'TR', 'UA', 'XK']


FNAME_ADMIN_CTRY_MAP: Dict[str, CtryCodes] = {'AN': 'AD',
                                              'AT': 'AT',
                                              'BE': 'BE',
                                              'CH': 'CH',
                                              'CZ': 'CZ',
