from typing import Union, Set, List, Dict, Tuple, Final, Literal
from .types_osm import OsmHighway, OsmNodeId, HikeSurface, OsmAccess
...
OsmHighwaySet = set[OsmHighway]
OsmAccessSet = set[OsmAccess]


CYCLING_HGWY_EXCL: Final[OsmHighwaySet] = set([
...
CYCLING_HGWY: OsmHighwaySet = set([
...
KEEP_HGWY: Final[OsmHighwaySet] = set([
...
PISTE_TYPE_BICYCLE: Final[Set[str]] = set([
    'nordic', 'sled', 'connection', 'fatbike', 'sleigh', 'nordic;fatbike', 
    'fatbike;hike', 'nordic;fatbike;hike', 'hike;fatbike', 'nordic;hike;fatbike'])

PARKING_NO_ACCESS: Final[OsmAccessSet] = set(['private', 'no', 'customers', 'delivery', 'limited'])

SUMMER_LS: Final[Set[str]] = set(['summer', 'yes', 'yes|summer'])

SERVICES_INVALID: Final[Set[str]] = set([
...
PERMISSIBLE_STATES: Final[OsmAccessSet] = set([
    'yes', 'Yes', 'designated', 'permissive', 'official', 'passable', 'fwd', 'bwd'])

NOT_PERMISSIBLE_STATES: Final[OsmAccessSet] = set([
...
DISUSED_HIGHWAYS: Final[Set[str]] = set([
...
FUTURE_HIGHWAYS: Final[Set[str]] = set(['proposed:highway', 'planned:highway'])


NATURAL_REGION: Final[Set[str]] = set(['mountain_range', 'mountain_area', 'tourism', 'valley'])
#NATURAL_REGION: Set[str] = set(['mountain_range', 'mountain_area', 'tourism', 'valley'])

RAILWAY_LS: Final[List[str]] = ['rail', 'subway', 'narrow_gauge', 'funicular']


CYCLE_TAGS: Final[Set[str]] = set([
...
TAG_MAP_DEP_ORDER: Final[List[str]] = [
...
SAC_SCALE_VALS: Final[List[str]] = [
    'strolling', 'hiking', 'mountain_hiking', 'demanding_mountain_hiking', 'alpine_hiking', 
    'demanding_alpine_hiking', 'difficult_alpine_hiking']

CLS_BICYCLE_MAP: Final[Dict[Union[str, int], int]] = {
    '-3': -3, '-2': -2, '-1': -1, '0': 0, '1': 1, '2': 2, '3': 3, 
    -3: -3, -2: -2, -1: -1, 0: 0, 1: 1, 2: 2, 3: 3}

CLS_BICYCLE_TAGS: Final[List[str]] = ["class:bicycle", "class:bicycle:touring", "class:bicycle:commute"]
# class:bicycle:trailer im Moment außen vor, da nur 20 Ways eine negative Bewertung haben
CLS_ROADBIKE_TAGS: Final[List[str]] = ["class:roadbike", "class:bicycle:roadcycling"]
CLS_MTB_TAGS: Final[List[str]] = ["class:bicycle:mtb", "class:bicycle:mtb:technical"]

MTB_TYPES: Final[Set[str]] = set([
...
MTB_TYPES_DOWNHILL: Final[List[str]] = ['downhill', 'freeride', 'slopestyle', 'dh', 'bikepark', 'northshore']
MTB_TYPES_UPHILL: Final[List[str]] = ['uphill', 'xc', 'crosscountry', 'allmountain', 'enduro', '0', '1', '2']
...
## TOURISM et al
TOURISM_TYPES: Final[Set[str]] = set([
...
TOURISM_SWIMMING: Final[Set[str]] = set(["swimming_area", "water_park", "beach_resort"])
                    # wilderness_hut <=> ist Gegensatz zu den anderen Optionen unbewirtschaftet

HISTORIC_TYPES: Final[Set[str]] = set([
...
AMENITY_TYPES: Final[Set[str]] = set([
...
REL_MEMBER_ROLES: Final[Set[str]] = set([
    'guidepost', 'giudepost', 'guidepost ', 'gudiepost', 'guidepost', 'route_marker', 
    'info', 'information', 'information:board', 'information_board', 'map'])

NETWORK_KEYS: Final[Set[str]] = set(['rcn', 'lcn', 'ncn', 'bicycle', 'rcn;rwn', 'rwn;rcn', 'lcn;lwn', 'lwn;lcn'])

HIKING_NETWORK_KEYS: Final[Set[str]] = set([
    'rwn', 'lwn', 'nwn', 'rcn;rwn', 'rwn;rcn', 'lcn;lwn', 'lwn;lcn', 'rwn;lwn', 'nwn;lwn'])

GP_LIST: Final[Set[str]] = {'guidepost', 'route_marker', 'map'}
...
WATERWAY_TYPES: Final[Dict[str, int]] = {'river': 1, 'canal': 2, 'rapids': 3, 'stream': 4, 'ditch': 5}

HIGHWAY_TYPES: Final[OsmHighwaySet] = {
    'trunk', 'trunk_link', 'raceway', 'motorway', 'motorway_link', 'primary', 
    'primary_link', 'secondary', 'secondary_link', 'tertiary', 'tertiary_link', 'road'}

FOOTWAY_TYPES: Final[Set[str]] = {
    'sidewalk', 'path', 'yes', 'link', 'designated', 'track', 'footway', 'pedestrian', 
    'shortcut', 'service', 'trail', 'footpath', 'boardwalk', 'crossing'}

CROSSING_TYPES: Final[Set[str]] = {'crossing', 'traffic_island', 'island'}
HIKING_HGWYS: Final[OsmHighwaySet] = {'trail', 'via_ferrata', 'bus_stop', 'ladder'}

highway2id: Final[Dict[OsmHighway, int]] = {hgwy: id for hgwy, id in zip(HIGHWAY_TYPES, range(len(HIGHWAY_TYPES)))}

WATERWAY_MEM_ROLES: Final[Set[str]] = set([
...
WATER_TYPE_PRIO: Final[Dict[Union[str, None], int]] = {
...
HIGHWAY_NODES: Final[Set[str]] = set([
...
FOOT_BARRIER_LS: Final[Set[str]] = set([
...
LOCALITY_TAG_VALS: Final[Set[OsmLocalityTag]] = set([
...
LRG_LOCALITY_TAG_VALS: Final[Set[OsmLocalityTag]] = {'city', 'island', 'municipality', 'town', 'village'}
# farm = isolated_dwelling (Einzelgehöfte oder alleinstehende Häuser)
LOCALITY_TAG_VALS_NOT_USED: Final[Set[OsmLocalityTag]] = {'archipelago', 'islet', 'plot', 'square', 'allotment'}
...
VIEWPTS_NODES: Set[OsmNodeId] = set([
